...
namespace Dobble.Domain
{
    public class Cards
    {
        public List<Card> lijst = new List<Card>()
        {
            ...
            new Card {picturelist = new List<string>() {"48","11","32","49","47","40","30","38"} },
            new Card {picturelist = new List<string>() {"33","32","31","29","27","26","3","28"} },
            new Card {picturelist = new List<string>() {"34","38","37","19","28","4","22","36"} },
            new Card {picturelist = new List<string>() {"34", "14","17","3","40","39","20","6"} },
            new Card {picturelist = new List<string>() {"42", "10","8","5","6","32","41","4"} },
            new Card {picturelist = new List<string>() {"10", "39", "16","11","7","50","29","22"} },
            new Card {picturelist = new List<string>() {"20","7","31","4","30","25","23","24"} },
            new Card {picturelist = new List<string>() {"34","23","16","35","32","1","18","15"} },
            new Card {picturelist = new List<string>() {"35","43","51","13","3","19","30","10"} },
            new Card {picturelist = new List<string>() {"34","51","45","5","52","33","7","49" } }
        };
